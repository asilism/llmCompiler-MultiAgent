...
def create_subagent_tool(mcp_agent, tool_name: str = "subagent", desc: str = None) -> StructuredTool:
    ...
    AGENT_TOOL_DESCRIPTION = (
        "contact_agent(input: str, context: Optional[list[str]]) -> str\n"
...
def get_contact_agent_tool() -> StructuredTool:
    ...
    contact_agent_tool = create_subagent_tool(agent, tool_name="contact_agent")

    return contact_agent_tool